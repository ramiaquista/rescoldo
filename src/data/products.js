export const CATEGORIES = [
  ...
  { id: "braseros", label: "Braseros" },
  { id: "asadores-fijos", label: "Asadores fijos" },
  { id: "parrillas-portatiles", label: "Parrillas portátiles" },
  { id: "accesorios", label: "Accesorios" },
];

export const PRODUCTS = [
  { slug: "fogonero-redondo-classic", category: "fogoneros", name: "Fogonero Redondo Classic",
  ...
  { slug: "fogonero-cuadrado-compacto", category: "fogoneros", name: "Fogonero Cuadrado Compacto",
  ...
  { slug: "fogonero-xl-para-grupos", category: "fogoneros", name: "Fogonero XL para Grupos",
  ...
  { slug: "fogonero-con-grilla", category: "fogoneros", name: "Fogonero con Grilla",
  ...
  { slug: "brasero-rustico", category: "braseros", name: "Brasero Rústico",
  ...
  { slug: "brasero-con-parrilla", category: "braseros", name: "Brasero con Parrilla",
  ...
  { slug: "brasero-portatil", category: "braseros", name: "Brasero Portátil",
  ...
  { slug: "brasero-hexagonal", category: "braseros", name: "Brasero Hexagonal",
  ...
  { slug: "asador-fijo-doble-parrilla", category: "asadores-fijos", name: "Asador Fijo Doble Parrilla",
  ...
  { slug: "asador-fijo-con-mesada", category: "asadores-fijos", name: "Asador Fijo con Mesada",
  ...
  { slug: "asador-fijo-compacto", category: "asadores-fijos", name: "Asador Fijo Compacto",
  ...
  { slug: "parrilla-plegable-camping", category: "parrillas-portatiles", name: "Parrilla Plegable Camping",
  ...
  { slug: "parrilla-portatil-a-gas", category: "parrillas-portatiles", name: "Parrilla Portátil a Gas",
  ...
  { slug: "parrilla-portatil-carbon", category: "parrillas-portatiles", name: "Parrilla Portátil Carbón",
  ...
  { slug: "set-de-utensilios-x5", category: "accesorios", name: "Set de Utensilios x5",
  ...
  { slug: "pinza-y-atizador", category: "accesorios", name: "Pinza y Atizador",
    desc: "Los dos imprescindibles para mover brasas y acomodar la leña sin quemarte.",
    measures: "2 piezas · 45cm de largo · Acero." },
  { slug: "guantes-ignifugos", category: "accesorios", name: "Guantes Ignífugos",
