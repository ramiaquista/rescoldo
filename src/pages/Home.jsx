...
export default function Home() {
  return (
    <>
      ...
      <section className="rs-band rs-flame-bg" style={{ padding: "var(--space-8) 0" }}>
        <div className="rs-band-inner">
          ...
          <div className="rs-grid-3" style={{ gap: "var(--space-6)" }}>
            {[
              ...
              <div key={f.title} className="feature-card elev-sm" style={{ padding: "var(--space-6) var(--space-5)", background: "var(--color-bg)" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div className="rs-grid-3" style={{ gap: "var(--space-5)" }}>
              {[
                ...
                <div key={s.n} className="feature-card elev-sm" style={{ position: "relative", zIndex: 1, padding: "var(--space-6) var(--space-5) var(--space-5)", background: "var(--color-bg)" }}>
                  <div
                    style={{
                      width: 54, height: 54, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center",
                      background: "var(--color-surface)", border: "2px solid var(--color-accent)", color: "var(--color-accent-700)",
